...
<div id="contentBox">
    <div class="room">
        ...
        <!--分页控制-->
        <div class="page" style="margin-top:10px;margin-left:350px;">
            <button class="btn btn-info btn-sm" id="pre_btn">上一页</button>
            <a href="#" id="page">1</a>
            <button class="btn btn-info btn-sm" id="next_btn">下一页</button>
        </div>
