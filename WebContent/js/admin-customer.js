...
$(function() {
	...
	$("#query_btn").click(function() {
		var v = $("#user_info option:selected").val();
		var t = $("#query").val();
		if (v == "user") {
			$.get("query_username.do", {u_username:t}, function(data) {
				$("#customer_body").html("");
				for (var i in data) {
					var tr = $("<tr></tr>");
			...
			$.get("query_name.do", {u_name:t}, function(data) {
				$("#customer_body").html("");
				for (var i in data) {
					var tr = $("<tr></tr>");
					var td1 = $("<td>" + data[i].u_id + "</td>");
			...
			$.get("query_tel.do", {u_tel:t}, function(data) {
				$("#customer_body").html("");
				for (var i in data) {
					var tr = $("<tr></tr>");
					var td1 = $("<td>" + data[i].u_id + "</td>");
