...
public class UserController {
	...
	// 拦截根据用户名查询用户信息请求
	@RequestMapping("query_username")
	@ResponseBody
	public List<User> query_username(String u_username) {
		List<User> list = UserService.queryUser(u_username);
		return list;
	}
	...
	@ResponseBody
	public List<User> query_name(String u_name) {
		List<User> list = UserService.queryByName(u_name);
		return list;
	}
	
	// 拦截根据姓名查询用户信息请求
	@RequestMapping("query_tel")
	@ResponseBody
	public List<User> query_tel(String u_tel) {
		List<User> list = UserService.queryByTel(u_tel);
		return list;
	}
